...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10630&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rshiny-server-cmd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rshiny-server-cmd` can be installed with:

```
conda install rshiny-server-cmd
```

It is possible to list all of the versions of `rshiny-server-cmd` available on your platform with:
